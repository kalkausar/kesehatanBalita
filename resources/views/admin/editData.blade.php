            ...
            <div class="row">
                <div class="col-12">
                    ...
                    <div class="card">
                        ...
                        <div class="card-body">
                            <form action="{{url('/updateData/')}}/{{$data->id}}" enctype="multipart/form-data" method="post">
                                {{csrf_field()}}
                                <div class="row">
                                    <div class="col">
                                    ...
                                    <div class="col">
                                        <div class="form-group">
                                            ...
                                            <select class="form-control" name="iterasi_id">
                                                ...
                                                <option value="{{$i->id}}" {{ $data->iterasi_id == $i->id ? 'selected' : '' }}>Iterasi Ke - {{$i->iterasi}}</option>
                                                @endforeach
                                            </select>
                                        </div>
                                    </div>
                                ...
                                <div class="row">
                                    <div class="col">
                                        <div class="form-group">
                                            ...
                                            <input type=number min=0 step=0.00001 class="form-control" name="c1" value="{{$data->c1}}">
                                        </div>
                                    </div>
                                    <div class="col">
                                        <div class="form-group">
                                            <label>Nilai C2</label>
                                            <input type=number min=0 step=0.00001 class="form-control" name="c2" value="{{$data->c2}}">
                                        </div>
                                    </div>
                                    <div class="col">
                                        <div class="form-group">
                                            <label>Nilai C3</label>
                                            <input type=number min=0 step=0.00001 class="form-control" name="c3" value="{{$data->c3}}">
                                        </div>
                                    </div>
                                </div>
