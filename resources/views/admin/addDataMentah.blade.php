            ...
            <div class="row">
                <div class="col-12">
                    ...
                    <div class="card">
                        ...
                        <div class="card-body">
                            <form action="/postDataMentah" enctype="multipart/form-Data Mentah" method="post">
                                {{csrf_field()}}
                                <div class="row">
                                    <div class="col">
                                ...
                                <div class="row">
                                    <div class="col">
                                        <div class="form-group">
                                            ...
                                            <input type=number class="form-control" name="jum_balita">
                                        </div>
                                    </div>
                                    <div class="col">
                                        <div class="form-group">
                                            <label>Jumlah Perkiraan Penderita</label>
                                            <input type=number class="form-control" name="jum_perkiraan">
                                        </div>
                                    </div>
                                    <div class="col">
                                        <div class="form-group">
                                            <label>Penderita ditemukan dan ditangani</label>
                                            <input type=number class="form-control" name="jum_ditemukan">
                                        </div>
                                    </div>
                                </div>
